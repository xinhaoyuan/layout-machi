...
function module.create(data)
   ...
   local function start_interactive(screen, embed_args)
       ...
       -- colors are in rgba
       local border_color = with_alpha(gears.color(beautiful.border_focus), 0.75)
       local active_color = with_alpha(gears.color(beautiful.bg_focus), 0.5)
       local open_color   = with_alpha(gears.color(beautiful.bg_normal), 0.5)
