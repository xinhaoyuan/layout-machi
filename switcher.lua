...
function module.start(c, exit_keys)
   ...
   local border_color = with_alpha(api.gears.color(api.beautiful.border_normal), 0.25)
   local border_color_hl = with_alpha(api.gears.color(api.beautiful.border_focus), 0.75)
