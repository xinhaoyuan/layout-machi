...
function module.start(c, exit_keys)
    ...
    local border_color = with_alpha(gears.color(beautiful.border_normal), 0.25)
    local border_color_hl = with_alpha(gears.color(beautiful.border_focus), 0.75)
    local fill_color = with_alpha(gears.color(beautiful.bg_normal), 0.25)
    local box_bg = with_alpha(gears.color(beautiful.bg_normal), 0.85)
